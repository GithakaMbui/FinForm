...
<div class="panel page industries-management">
	...
	<section class="content">
		...
		<?php endif; ?>
		<hr class="divider"/>
		<form class="form" method="post" action="<?php echo base_url("dashboard/editindustry/$user->id/$industry->id"); ?>">
			<div class="row">
				<div class="col-md-6 row">
					<div class="form-group">
						<label class="form-label col-md-2">Name</label>
						<div class="col-md-8">
							<input class="form-control" type="text" name="industry[name]" value="<?php echo $industry->name; ?>"/>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="form-group">
					<div class="col-md-11">
						<textarea class="form-control" name="industry[description]" placeholder="Enter brief industry description here"><?php echo $industry->description; ?></textarea>
					</div>
					<span class="clearfix"></span>
				</div>
				<div class="form-group">
