...
<div class="panel page products-management">
	...
	<section class="content">
		...
		<?php endif; ?>
		<hr class="divider"/>
		<form class="form" method="post" action="<?php echo base_url("dashboard/addregion/$user->id"); ?>">
			<div class="row">
				<div class="col-md-6 row">
					<div class="form-group">
						<label class="form-label col-md-2">Name</label>
						<div class="col-md-8">
							<input class="form-control" type="text" name="region[name]" value="<?php if(isset($name)) echo $name; ?>"/>
						</div>
					</div>
				</div>
				<div class="col-md-6 row">
					<div class="form-group">
						...
						<div class="col-md-8">
							<input class="form-control" type="text" name="region[country]" value="<?php if(isset($country)) echo $country; ?>"/>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="form-group">
					<div class="col-md-11">
						<textarea class="form-control" name="region[description]" placeholder="Enter brief description of the region here"><?php if(isset($description)) echo $description; ?></textarea>
					</div>
					<span class="clearfix"></span>
				</div>
				<div class="form-group">
