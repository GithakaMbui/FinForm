...
<div class="panel page form-page add-user">
	<header class="header">
		<h2 class="title">
			...
			&nbsp;Remove <?php echo ucwords(strtolower($category->name)); ?>
	...
	<section class="content">
		<div class="panel panel-panel panel-danger">
			<div class="panel-heading">
				<i class="fa fa-warning"></i>&nbsp;Remove category permanently
			</div>
			<div class="panel-body">
				...
				<div class="col-md-12">
					...
					<a class="btn btn-danger btn-proceed" href="<?php echo base_url("dashboard/removecategory/$user->id/$category->id/?usr_ok=true"); ?>">
						Proceed
					</a>
				</div>
			</div>
